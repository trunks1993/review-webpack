 ...
 * @LastEditors: Dad
 * @LastEditTime: 2020-07-16 16:46:55
 */
    ...
    <div className="app-list">
      <div className="app-list--head">
        <span className="app-list--headImg">
          <img src={list?.iconUrl ? process.env.FILE_URL + list?.iconUrl : UNHEAD} alt="" />
        </span>
        ...
        <span className="app-list--headIcon" onClick={() => showDeleteConfirm(list?.id)}>
          <img src={DELETE} alt="" />
        </span>
      </div>
      <div className="app-list--content">
        ...
        <div className="app-list--keyVal">
          ...
          <span className="app-list-val" style={{ fontSize: 10 }}>
            {appVisible[list.id] ? arrSecret[list.id] : '**********************'}
          </span>
          <span className="app-list-visible" onClick={() => setVisible(list?.id)}>
            <img src={appVisible[list.id] ? EYE : UNEYE} alt="" />
          </span>
        </div>
      </div>
      <div className="app-list--footer">
        <Button className="app-list--leftBut">应用配置</Button>
        <Button className="app-list--rightBut">修改</Button>
      </div>
    </div>
  );
};
